            ...
            <div> <br></br>
                <div className='card col-md-6 offset-md-3'>
                    ...
                    <div className='card-body'>
                        ...
                        <div className='row'>   
                            <p><strong>Employee Department Code</strong> {this.state.employee.departmentCode}</p>
                        </div>
                        <div className='row'>
                            <p><strong>Employee Organization Code</strong> {this.state.employee.organizationCode}</p>
                        </div> 
                    </div>
                    ...
                    <div className='card-body'>
                        ...
                        <div className='row'>    
                            <p><strong>Organization Created At</strong> {this.state.organization.createdAt}</p>
                        </div>
                    </div>
                </div>
            </div>
